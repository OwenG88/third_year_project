## The creation of a new class for the quantum algorithms
## allows the two to be entirely separated.
## Most of the code here will be very similar to the classical
## case.
## The main reason for this separation is that it may be 
## necessary to optimise this code for the quantum case as
## the quantum algorithms are likely to take longer to run
